###########################################################################
## Makefile generated for Simulink model 'MainModel_LRL'. 
## 
## Makefile     : MainModel_LRL.mk
## Generated on : Sat Oct 25 20:25:33 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MainModel_LRL.elf
...
COMPILER_COMMAND_FILE     = MainModel_LRL_comp.rsp
CMD_FILE                  = MainModel_LRL.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MainModel_LRL.elf
...
DEFINES_STANDARD = -DMODEL=MainModel_LRL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o mw_sdk_interface.o MW_digitalIO.o MW_AnalogInput.o MainModel_LRL.o MainModel_LRL_data.o MainModel_LRL_tgtconn.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/MainModel_LRL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/MainModel_LRL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MainModel_LRL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/MainModel_LRL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MainModel_LRL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/MainModel_LRL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MainModel_LRL.o : $(START_DIR)/MainModel_LRL_ert_rtw/MainModel_LRL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MainModel_LRL_data.o : $(START_DIR)/MainModel_LRL_ert_rtw/MainModel_LRL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MainModel_LRL_tgtconn.o : $(START_DIR)/MainModel_LRL_ert_rtw/MainModel_LRL_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
