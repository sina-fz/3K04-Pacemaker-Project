###########################################################################
## Makefile generated for Simulink model 'AAIRVVIRWORK'. 
## 
## Makefile     : AAIRVVIRWORK.mk
## Generated on : Sun Nov 23 16:20:46 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AAIRVVIRWORK.elf
...
PRODUCT_NAME              = AAIRVVIRWORK
MAKEFILE                  = AAIRVVIRWORK.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/sinaf/OneDrive/Desktop/Year3/pacemaker-repo/3K04-Pacemaker-Project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = AAIRVVIRWORK_comp.rsp
CMD_FILE                  = AAIRVVIRWORK.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AAIRVVIRWORK.elf
...
DEFINES_STANDARD = -DMODEL=AAIRVVIRWORK -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_AnalogInput.o MW_SCI.o i2c_api.o MW_I2C.o MW_PWM.o AAIRVVIRWORK.o AAIRVVIRWORK_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AAIRVVIRWORK.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/AAIRVVIRWORK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AAIRVVIRWORK_data.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/AAIRVVIRWORK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/AAIRVVIRWORK_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
