###########################################################################
## Makefile generated for Simulink model 'AOORVOORWORKs'. 
## 
## Makefile     : AOORVOORWORKs.mk
## Generated on : Sun Nov 23 00:02:41 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AOORVOORWORKs.elf
...
COMPILER_COMMAND_FILE     = AOORVOORWORKs_comp.rsp
CMD_FILE                  = AOORVOORWORKs.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AOORVOORWORKs.elf
...
DEFINES_STANDARD = -DMODEL=AOORVOORWORKs -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_AnalogInput.o MW_SCI.o i2c_api.o MW_I2C.o MW_PWM.o AOORVOORWORKs.o AOORVOORWORKs_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AOORVOORWORKs.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/AOORVOORWORKs.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AOORVOORWORKs_data.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/AOORVOORWORKs_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/AOORVOORWORKs_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
